...
console.log("Après 3 setState — mot de passe conservé:", passField2 && passField2.value === "***REMOVED***");

const ok = userField2 && userField2.value === "admin" && passField2 && passField2.value === "***REMOVED***";
