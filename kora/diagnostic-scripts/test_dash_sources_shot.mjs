...
// Scroller vers la section Sources
await p.evaluate(() => document.querySelector('.sources-section')?.scrollIntoView());
await p.waitForTimeout(500);
await p.screenshot({ path: 'kora_dash_sources.png', fullPage: false });
await b.close().catch(()=>{});
process.exit(0);
