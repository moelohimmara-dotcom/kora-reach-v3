...
def main():
    ...
    facts = [
        {"fact_id": "f1", "article_retenu": {"title": "A", "image": "https://x.example/meme.jpg"}, "sources_secondaires": []},
        {"fact_id": "f2", "article_retenu": {"title": "B", "image": "https://x.example/meme.jpg"}, "sources_secondaires": [
